...
│  → concept/angle 추출 → forbidden zone 생성              │
...
│  references.json에서 해당 토픽 URL → WebFetch로 참조     │
│  (fetch 실패 시 LLM 내부 지식으로 fallback)              │
...
│  입력: concept별 3개 keyAngle + 레퍼런스 URL              │
...
- references.json의 URL fetch 실패 시 → LLM 내부 지식으로 진행
- 리포트에 "Reference fetch failed: {url}" 경고 표기
  ...
  "general": [
    {
      ...
      "description": "MIT 전 과목 강의 자료 (강의 노트, 시험, 문제 세트)"
    },
    {
      "name": "GeeksforGeeks",
      "url": "https://www.geeksforgeeks.org/",
      "description": "CS 전 분야 구조화된 학습 자료 및 코드 예제"
    },
    {
      "name": "Khan Academy — Computing",
      "url": "https://www.khanacademy.org/computing/computer-science",
      "description": "알고리즘, 자료구조, 암호학 입문 수준 자료"
    }
  ],
  "topics": {
    "algorithm": [
      {
        ...
        "description": "정렬, DP, 그래프 알고리즘, 해싱. 강의 영상 + 노트 + 문제 세트"
      },
      {
        "name": "Khan Academy — Algorithms",
        "url": "https://www.khanacademy.org/computing/computer-science/algorithms",
        "description": "탐색, 정렬, 재귀, 그래프 이론. 시각화 + 코딩 챌린지"
      }
    ],
    "dataStructure": [
      {
        ...
        "description": "배열, 링크드리스트, 해시 테이블, BST, 힙, 그래프. Creative Commons 교재"
      },
      {
        "name": "MIT OCW 6.851 — Advanced Data Structures",
        "url": "https://ocw.mit.edu/courses/6-851-advanced-data-structures-spring-2012/",
        "description": "학부 이상 수준의 고급 자료구조"
      }
    ],
    "database": [
      {
        "name": "CMU 15-445/645 — Intro to Database Systems",
        "url": "https://15445.courses.cs.cmu.edu/",
        "description": "관계형 모델, SQL, 인덱싱, 트랜잭션, 쿼리 최적화, 동시성 제어"
      },
      {
        "name": "Stanford Online — Databases",
        "url": "https://online.stanford.edu/courses/soe-ydatabases0005-databases-relational-databases-and-sql",
        "description": "SQL, 관계형 모델링, 데이터베이스 이론. Jennifer Widom 교수"
      }
    ],
    "operatingSystem": [
      {
        ...
        "description": "가상화, 동시성, 영속성. 무료 전문 교재. OS 교재의 표준"
      },
      {
        "name": "MIT OCW 6.1810 — Operating System Engineering",
        "url": "https://ocw.mit.edu/courses/6-1810-operating-system-engineering-fall-2023/",
        "description": "MIT OS 강의 (Fall 2023). 강의 노트 + 실습 자료"
      }
    ],
    "computerNetworking": [
      {
        "name": "Kurose/Ross — Computer Networking Companion",
        "url": "https://gaia.cs.umass.edu/kurose_ross/index.php",
        "description": "강의 영상, Wireshark 실습, 인터랙티브 애니메이션 (교재 컴패니언)"
      },
      {
        "name": "MIT OCW 6.033 — Computer System Engineering",
        "url": "https://ocw.mit.edu/courses/6-033-computer-system-engineering-spring-2018/",
        "description": "네트워킹, 네이밍, 보안, 분산 시스템"
      }
    ],
    "computerArchitecture": [
      {
        ...
        "description": "논리 게이트부터 OS까지 컴퓨터 전체 구축. 무료 강의 자료"
      },
      {
        "name": "MIT OCW 6.823 — Computer System Architecture",
        "url": "https://ocw.mit.edu/courses/6-823-computer-system-architecture-fall-2005/",
        "description": "명령어 설계, 파이프라이닝, 캐시, 가상 메모리, I/O"
      }
    ],
    "computerSecurity": [
      {
        "name": "UC Berkeley CS161 — Computer Security Textbook",
        "url": "https://textbook.cs161.org/",
        "description": "메모리 안전성, 암호학, 웹 보안, 네트워크 보안. CC BY-SA 4.0"
      },
      {
        "name": "MIT OCW 6.857 — Network and Computer Security",
        "url": "https://ocw.mit.edu/courses/6-857-network-and-computer-security-spring-2014/",
        "description": "암호학, 네트워크 보안. Ron Rivest 교수"
      },
      {
        "name": "NIST CSRC",
        "url": "https://csrc.nist.gov/",
        "description": "보안 표준, 가이드라인. SP 800 시리즈 무료 제공"
      }
    ],
    "softwareEngineering": [
      {
        "name": "SWEBOK v4 — IEEE Computer Society",
        "url": "https://www.computer.org/education/bodies-of-knowledge/software-engineering",
        "description": "소프트웨어 공학 지식 체계. 요구사항, 설계, 테스트, 유지보수, 품질"
      },
      {
        "name": "MIT OCW 6.033 — Computer System Engineering",
        "url": "https://ocw.mit.edu/courses/6-033-computer-system-engineering-spring-2018/",
        "description": "복잡성, 모듈성, 결함 허용, 분산 시스템"
      }
    ],
    "springBoot": [
      {
        "name": "Spring Boot Official Documentation",
        "url": "https://docs.spring.io/spring-boot/reference/index.html",
        "description": "공식 레퍼런스. 자동 설정, 데이터 접근, 웹, 보안, 테스트, 배포"
      },
      {
        "name": "Spring.io Guides",
        "url": "https://spring.io/guides",
        "description": "공식 단계별 튜토리얼"
      },
      {
        "name": "Baeldung — Spring Boot",
        "url": "https://www.baeldung.com/spring-boot",
        "description": "커뮤니티 레퍼런스. 설정, 데이터, 보안, REST, WebFlux, 테스트"
      }
    ]
  }
}
...
1. references.json에 해당 토픽 항목이 있으면 → WebFetch로 커리큘럼/목차 참조
2. WebFetch 실패 시 → LLM 내부 지식으로 진행 + 리포트에 경고
3. references.json에 해당 토픽이 없으면 → 웹 검색으로 대학 강의 실러버스 탐색
...
⚠️  Warnings
  Reference fetch failed: https://ocw.mit.edu/courses/6-006-...
    → Proceeded with LLM internal knowledge
