...
const KEYWORD_ALIASES: Record<string, Record<string, string>> = {
  ...
  distributedSystem: {
    "paxos": "Consensus Protocols",
    "raft": "Consensus Protocols",
    "zab": "Consensus Protocols",
    "pbft": "Consensus Protocols",
    "byzantine": "Fault Tolerance",
    "crash fault": "Fault Tolerance",
    "failure detector": "Fault Tolerance",
    "dht": "Distributed Storage",
    "lsm-tree": "Distributed Storage",
    "lsm tree": "Distributed Storage",
    "tcc": "Distributed Transactions",
    "try-confirm-cancel": "Distributed Transactions",
    "saga": "Distributed Transactions",
    "2pc": "Distributed Transactions",
    "range partitioning": "Partitioning",
    "hash partitioning": "Partitioning",
    "consistent hashing": "Partitioning",
    "message queue": "Messaging Systems",
    "delivery semantics": "Messaging Systems",
